...
# my_connection = create_connection('group_51.db')
# if my_connection is not None:
#     print('Connected to database!')
#     # create_table(my_connection, sql_to_create_employees_table)
#     insert_employee(my_connection, ('Nurperi', 2400.5, 'Programming', '2000-01-02', True))
#     insert_employee(my_connection, ('Jumagul', 2500.5, 'Football', '2000-12-30', False))
#     my_connection.close()

db_name = '''group_51.db'''
# insert_employee(db_name, ('Jumagul', 2500.5, 'Football', '2000-12-30', False))
...
# update_employee(db_name, (3000, True, 2))
# delete_employee(db_name, 2)

# select_all_employees(db_name)
select_employees_by_salary(db_name, 2400)